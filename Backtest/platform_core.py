...
class Backtest():
    ...
    def postprocessing(self, data, conditions):
        """
        ...
        Inputs:
        - data: current asset dataframe
        - conditions: tuple (buy, sell, short, cover) boolean DataFrames generated by logic()

        Returns:
        - Optional tuple of new conditions (buy, sell, short, cover) if modified.
        """
        return conditions
